          ...
          <div className="space-y-8 text-[var(--text-secondary)] leading-relaxed">
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-3 ml-1">
                <li>Email us at <a href="mailto:support@toyhype.in" className="text-[var(--accent-blue)] font-semibold hover:underline">support@toyhype.in</a> within 7 days of delivery.</li>
            ...
            <section className="bg-[var(--bg-warm)] rounded-2xl p-6 flex gap-4">
              ...
              <div>
                ...
                <p className="mt-2">
                  <a href="mailto:support@toyhype.in" className="text-[var(--accent-blue)] font-bold hover:underline text-lg">
                    support@toyhype.in
                  </a>
                </p>
